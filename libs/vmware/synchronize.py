...
from libs.vmware.host import VMWareHostAPI
...
# 用来标记这是vmware的作业
DEFAULT_CLOUD_NAME = "vmware"

# 同步的资产对应关系
mapping: Dict[str, dict] = {"host": {"type": "server", "obj": VMWareHostAPI}}


def sync(data: Dict[str, Any]):
    """
    vmware统一资产入库，云厂商用for，产品用并发，地区用for
    """
    # 参数
